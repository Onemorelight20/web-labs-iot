      ...
      <Grid container spacing={2}>
        <Grid item xs>
          ...
          <Typography variant="body1" sx={{ mt: 2 }}>
            ...
            both an art and an industry. From{" "}
            <a href="https://www.myenglishpages.com/english/reading-film.php">
              here
            </a>
            .
          </Typography>
        ...
        <Grid item xs>
          <Box component="img" src={filmPicture} className={classes.bigImage} />
        </Grid>
      </Grid>
    </Box>
  );
